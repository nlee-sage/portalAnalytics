...
# Author: Nicholas Lee
# Project: Portal Analytics - ML annotations
# Version: 1.0.0
# Release Date: <date>
# License: MIT
...
def train_and_evaluate(
    train_model_spec, eval_model_spec, model_dir, params, restore_from=None
):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(begin_at_epoch, begin_at_epoch + params.num_epochs):
            # Run one epoch
            logging.info(
                "Epoch {}/{}".format(epoch + 1, begin_at_epoch + params.num_epochs)
            )
